...
Пересечение резьбовых поверхностей - действительно сложная расчетная задача. Практической ценности никакой, но выглядит неплохо. И как тест - задачка отменная. Вычисление занимает полторы миинуты. Достойная цель для ленификации. 
</spoiler>
...
* Невероятная:  
  Произошла коллизия хэшключа в кэше. Для алгоритма sha256, имеющего пространство в 115792089237316195423570985008687907853269984665640564039457584007913129639936 возможных ключей, вероятность получить коллизию практически ничтожна.
* Вероятная:  
